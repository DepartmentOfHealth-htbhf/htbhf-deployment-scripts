...
perform_first_time_deployment() {
  ...
  cf push -p ${APP_PATH} --var suffix=-${CF_SPACE} --var session_secret="secret_${SESSION_SECRET}"
...
perform_blue_green_deployment() {
  ...
  cf push -p ${APP_PATH} --var suffix=-${CF_SPACE}-green --var session_secret="secret_${SESSION_SECRET}" --no-route
